    ...
    <div class="py-4 admin-page-info">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <h2 class="h4"> <i class="fa-solid fa-marker text-primary"></i> Authors List</h2>
                <p class="mb-0">You can manage this table  and do all opration system create , show, edit and delete</p>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0"><a href="{{ route('admin.author.create') }}"
        ...
        <div class="table-settings mb-4">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-9 col-lg-8 d-md-flex">
                    <form action="{{ route('admin.author.search') }}" method="POST"
                        ...
                        <input type="text" name="search" class="form-control @error('search') is-invalid @enderror"
                            placeholder="Search authors by name" value='{{ Request::input('search') }}'
                        ...
                        <div class="btn-group">
                            <div class="dropdown me-1">
                                ...
                                <div class="dynamic-pagination dropdown-menu dropdown-menu-end pb-0">
                                    ...
                                    <a class="dropdown-item {{ Request::is('*/perPage/10') ? 'active' : '' }} {{ Request::is('admin/author') ? 'active' : '' }}"
                                        href="{{ route('admin.author.perPage', 10) }}"> 10 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/30') ? 'active' : '' }}"
                                        href="{{ route('admin.author.perPage', 30) }}"> 30 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/50') ? 'active' : '' }}"
                                        href="{{ route('admin.author.perPage', 50) }}"> 50 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/100') ? 'active' : '' }}"
                                        href="{{ route('admin.author.perPage', 100) }}"> 100 </a>
        ...
        @else
            ...
            <div class="card card-body shadow border-0 table-wrapper table-responsive">
                ...
                <!----------- multi Action ------------->
                <form id="multi-action-form" action="{{ route('admin.author.multiAction') }}" method="POST">
                    <div class="pb-3">
                        ...
                        <tbody>
                            @foreach ($authors as $author)
                                <tr>
                                            ...
                                            <div class="d-block">
                                                <span class="fw-bold">
                                                    @if ( strlen($author->name) > 30 )
                                                        {{ Str::ucfirst( substr( $author->name , 0, 30 )) }}...
                                                    @else
                                                        {{  Str::ucfirst( $author->name ) }}
                                                    @endif
                                                </span>
                                    ...
                                    <td><span class="fw-normal">{{ $author->created_at }}</span></td>
                                    <td class="actions">
                                        <a href="{{ route('admin.author.show', $author->id) }}" class="text-tertiary">
                                            <i class="fa-solid fa-eye fa-lg"></i> </a>
                                        <a href="{{ route('admin.author.edit', $author->id) }}" class="text-info"> <i
                                                class="fa-solid fa-pen-to-square fa-lg"></i> </a>
                                        <a href="{{ route('admin.author.destroy', $author->id) }}"
                    ...
                    <div
                        ...
                        <div class="fw-normal small mt-4 mt-lg-0">
                            Showing <b>{{ $authors->firstItem() }}</b> to <b>{{ $authors->lastItem() }}</b>
                            of total <b>{{ $authors->total() }}</b> entries
                        </div>
                    </div>
                </form>
            </div>
