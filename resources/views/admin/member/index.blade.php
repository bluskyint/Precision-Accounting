    ...
    <div class="py-4 admin-page-info">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('admin.member.create') }}" class="btn btn-sm btn-primary d-inline-flex align-items-center">
                    <i class="fa-solid fa-plus"></i> &nbsp;New Member</a>
            </div>
            @endcan
        </div>
                        ...
                        <tbody>
                            @foreach ($members as $member)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.member.show', $member->slug) }}" class="d-flex align-items-center"><img
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.member.show', $member->slug) }}" class="text-tertiary">
                                            <i class="fa-solid fa-eye fa-lg"></i>
                                        </a>
                                        @can('Edit Members')
                                        <a href="{{ route('admin.member.edit', $member->slug) }}" class="text-info">
                                            <i class="fa-solid fa-pen-to-square fa-lg"></i>
                                        </a>
                                        @endcan
                                        @can('Delete Members')
                                        <a href="{{ route('admin.member.destroy', $member->slug) }}" class="text-info delete-record">
